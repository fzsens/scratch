...
export function FileIcon({ className = "w-4.5 h-4.5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function FileTextIcon({ className = "w-4.5 h-4.5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function FilePdfIcon({ className = "w-4.5 h-4.5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
    ...
    >
      <path d="M14 3v4a1 1 0 0 0 1 1h4" />
      <path d="M17 21H7a2 2 0 0 1 -2 -2V5a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" />
      <path d="M8 16v-4h1.5a1.25 1.25 0 0 1 0 2.5H8" />
      <path d="M12 16v-4h1a2 2 0 0 1 0 4h-1" />
      <path d="M17 16v-4h2" />
      <path d="M17 14h1.5" />
    </svg>
  );
...
export function OllamaIcon({
  ...
  return (
    <svg className={className} fill="currentColor" viewBox="9 1 42 50">
      <title>Ollama icon</title>
